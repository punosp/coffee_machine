...
public class HotWaterFulfillment implements BeverageFulfillMent {

    private TotalItemsQuantity totalItemsQuantity;
    private CalculateIngredients calculateIngredients;

    public HotWaterFulfillment(TotalItemsQuantity totalItemsQuantity) {
...
//            }).start();
            pourBeverage.pour(Collections.singleton(BeverageType.hotWater));
        }

        String message = calculateIngredients.getMessage(BeverageType.hotWater, validityResponse);
