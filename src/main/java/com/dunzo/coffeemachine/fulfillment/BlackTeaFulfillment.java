...
public class BlackTeaFulfillment implements BeverageFulfillMent {

    private TotalItemsQuantity totalItemsQuantity;
    private CalculateIngredients calculateIngredients;

    public BlackTeaFulfillment(TotalItemsQuantity totalItemsQuantity) {
...
//            }).start();
            pourBeverage.pour(Collections.singleton(BeverageType.blackTea));
        }

        String message = calculateIngredients.getMessage(BeverageType.blackTea, validityResponse);
